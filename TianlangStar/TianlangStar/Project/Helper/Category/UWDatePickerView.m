...
//    self.sureBtn.layer.borderColor = [UIColor colorWithRed:25 green:158 blue:216 alpha:1].CGColor;
...
- (IBAction)removeBtnClick:(id)sender {
    ...
    [self.delegate getSelectDate:self.selectDate type:self.type button:sender];
}
